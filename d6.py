...
if not cap.isOpened():
    raise RuntimeError("Kamera tidak bisa dibuka. Coba index kamera lain (1/2).")
...
while True:
    ...
    cv2.putText(img, f"Mode: {MODE.upper()}  Count: {count}",
